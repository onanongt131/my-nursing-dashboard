  ...
  useEffect(() => {
    async function fetchWardDetails() {
      ...
      try {
        ...
        const admissionTotal = ewAdm + tIn;
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-bold text-slate-900 tracking-wide">Ward Command Center</h1>
          ...
          <p className="text-xs text-slate-500 mt-0.5">สถานะหอผู้ป่วยแบบใกล้เคียงเวลาจริง</p>
        </div>
